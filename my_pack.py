...
def nonlocals() -> dict:
    ...
    Note: only globals allows getting, setting, and deleting values; locals and nonlocals only allows getting values (unless the value is not defined in the scope in which case you can edit the value)
